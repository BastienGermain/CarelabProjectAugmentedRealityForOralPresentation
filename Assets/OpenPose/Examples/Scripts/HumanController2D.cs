...
namespace OpenPose.Example {
    ...
    public class HumanController2D : MonoBehaviour {
        ...
        public void DrawHuman(ref OPDatum datum, int bodyIndex, float scoreThres = 0){
            ...
            // Addition to the original OpenPose plugin
            if (behaviourTracker && GameObject.Find("2_RShoulder") && GameObject.Find("5_LShoulder"))
            {
        ...
        void Start() {
            ...
            // Addition to the original OpenPose plugin
            behaviourTracker = GameObject.Find("BehaviourTracker").GetComponent<BehaviourTracker>();
        }
